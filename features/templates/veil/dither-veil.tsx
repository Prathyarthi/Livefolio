...
// Adapted from React Bits "Dither Veil" (https://reactbits.dev/animations/dither-veil).
...
export interface DitherVeilProps {
  ...
  wander?: boolean;
  clickBurst?: boolean;
  /** Called when the image or WebGL context can't be loaded (e.g. missing CORS headers). */
  onError?: () => void;
  className?: string;
  style?: CSSProperties;
}

type Settings = Required<Omit<DitherVeilProps, 'src' | 'onError' | 'className' | 'style'>>;
